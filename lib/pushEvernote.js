...
(function() {
  var PushEvernote, Task, async, cheerio, crypto, inlineCss, makeNote, noteStore, p, request;
  ...
  PushEvernote = (function() {
    function PushEvernote(noteStore, noteBook) {
      this.noteStore = noteStore;
      this.noteBook = noteBook;
    }

    PushEvernote.prototype.pushNote = function(html, cb) {
      var self;
      self = this;
    ...
    PushEvernote.prototype.findTask = function(cb) {
      return Task.find({
        status: 1
      }, null, {
        sort: {
    ...
    PushEvernote.prototype.changeContent = function(url, title, cb) {
      var self;
      self = this;
      return async.waterfall([
        function(callback) {
          ...
          return self.changeImgHtml($cHtml, title, cb);
        }
      ]);
    };

    PushEvernote.prototype.changeImgHtml = function($, title, cb) {
      var imgs, self;
      self = this;
      imgs = $("img");
